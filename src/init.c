...
static DefaultFile default_files[] = {
  { "ux0:data/RetroFlow/module/kernel.skprx",    (void *)&_binary_modules_kernel_kernel_skprx_start,
                                               (int)&_binary_modules_kernel_kernel_skprx_size, 1 },
  { "ux0:data/RetroFlow/module/user.suprx",      (void *)&_binary_modules_user_user_suprx_start,
                                               (int)&_binary_modules_user_user_suprx_size, 1 },
  { "ux0:data/RetroFlow/module/patch.skprx",     (void *)&_binary_modules_patch_patch_skprx_start,
...
void installDefaultFiles() {
  ...
  // sceIoMkdir("ux0:data/RetroFlow", 0777);
  sceIoMkdir("ux0:data/RetroFlow/module", 0777);
...
void initCopyIcons() {
  ...
  if(search_modid < 0) {
    patch_modid = taiLoadKernelModule("ux0:data/RetroFlow/module/patch.skprx", 0, NULL);
    if (patch_modid >= 0) {
  ...
  if(search_modid < 0) {
    kernel_modid = taiLoadKernelModule("ux0:data/RetroFlow/module/kernel.skprx", 0, NULL);
    if (kernel_modid >= 0) {
  ...
  user_modid = sceKernelLoadStartModule("ux0:data/RetroFlow/module/user.suprx", 0, NULL, 0, NULL, NULL);

}

void finishCopyIcons() {
}
